...
import life.genny.util.MergeUtil;
import life.genny.util.StringFormattingUtils;
	  ...
	  public MailAttachment getAttachment(QBaseMSGAttachment message, Map<String, Object> contextMap) {
		...
		if(content != null) {
			...
			if(contentBytes != null) {
				...
				if(message.getAttachmentType().equals(QBaseMSGAttachment.AttachmentType.INLINE)) {
