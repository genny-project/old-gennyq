...
public abstract class CodedEntity extends CoreEntity {
     ...
     * Constructor.
     *
     * @param aCode the unique code of the coded entity
     * @param aName the summary name of the coded entity
     */
    ...
    /**
     * @param aCode human readable text representing the unique code
     */
