...
public class AnswerLink implements java.io.Serializable {
     ...
     * @param target the associated Attribute
    ...
    public void setAnswer(final Answer answer) {
        ...
        switch (this.getAttribute().dataType.getClassName()) {
    ...
    public String toString() {
        return "EE[" + getTarget().getCode() + ":" + created + ", linkType=" + getAttribute().code + ",weight="
    ...
    @XmlTransient
    public <T> T getValue() {
        final String dataType = getAttribute().dataType.getClassName();
        switch (dataType) {
            case "life.genny.qwanda.entity":
    ...
    public <T> void setValue(final Object value) {
        switch (this.pk.getAttribute().dataType.getClassName()) {
            case "life.genny.qwanda.entity":
