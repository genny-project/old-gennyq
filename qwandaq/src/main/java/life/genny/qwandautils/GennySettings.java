...
public class GennySettings {
    public static final Boolean skipGoogleDocInStartup = "TRUE".equalsIgnoreCase(System.getenv("SKIP_GOOGLE_DOC_IN_STARTUP"));
    public static final String mainrealm = System.getenv("PROJECT_REALM") != null ? System.getenv("PROJECT_REALM") : "genny"; // UGLY
    ...
    public static final String GENNY_REALM = "jenny"; //deliberatly not genny
    public static final boolean isSynchronise = "TRUE".equalsIgnoreCase(System.getenv("SYNC_GOOGLE_DOC"));
